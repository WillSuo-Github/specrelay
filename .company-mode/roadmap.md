...
| Collect first reviews | Product/user evidence is still missing | 5 qualitative reviews, with at least 2 strong intent signals | Growth + Support/Research | 2 useful X responses, 0 strong intent signals; Afterbuild Labs and Bytewise emails sent and awaiting replies; AC Tech Labs route is staged if those two paths fail |
