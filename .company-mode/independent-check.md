...
| --- | --- | --- | --- |
| Evidence support | 3 | GitHub issue state, live URL, the verified Marty reply URL, current direct-status engagement state showing no founder reply and `8` views, and repo-backed MVP output | no unsupported demand signal or send claim was added |
